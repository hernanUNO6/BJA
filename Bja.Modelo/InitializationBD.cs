...
namespace Bja.Modelo
{
    public class InicializacionBD
    {
        public static void inicializarBD()
        {
            ...
            Medico medico = new Medico() { Nombres = "Herbert", PrimerApellido = "Saal", SegundoApellido = "Gutierrez", 
                DocumentoIdentidad = "43123333", TipoDocumentoIdentidad = TipoDocumentoIdentidad.CarnetIdentidad, 
                CorreoElectronico = "herbert.saal@gmail.com", EstadoRegistro = TipoEstadoRegistro.VigenteNuevoRegistro,
                FechaNacimiento = DateTime.Parse("05/04/1976"), LocalidadNacimiento = "La Paz", MatriculaColegioMedico = "1234567890"
            };
            ...
            EstablecimientoSalud establecimientoSalud = new EstablecimientoSalud() { Codigo = "HO", Nombre = "Hospital Obrero", 
                Direccion = "Miraflores", IdRedSalud = redSalud.Id };
